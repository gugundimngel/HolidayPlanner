...
class TestimonialController extends Controller
{
	...
	public function store(Request $request)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/admin/testimonial')->with('success', 'Testimonial added Successfully');
			}
		}			
	}
	...
	{	
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/admin/testimonial')->with('success', 'Testimonial '.Config::get('constants.edited'));
			}				
		}
		else
		{	
			if(isset($id) && !empty($id))
			{
				...
				{
					return Redirect::to('/admin/testimonial')->with('error', 'Testimonial '.Config::get('constants.not_exist'));
				}	
			}
			else
			{
				return Redirect::to('/admin/testimonial')->with('error', Config::get('constants.unauthorized'));
			}		
		}				
	}
