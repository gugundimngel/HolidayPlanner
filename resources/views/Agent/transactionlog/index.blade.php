							...
							<div class="row">
								...
								<div class="col-md-12 text-left">
									<ul class="mb-0 list-inline">
										...
										<li class="list-inline-item"><a href="{{URL::to('agent/excel_transaction_log')}}/?fromdate={{Request::get('fromdate')}}&todate={{Request::get('todate')}}" class="btn btn-primary"><i class="fa fa-file-excel"></i> Export</a></li>
									</ul>
								</div>
