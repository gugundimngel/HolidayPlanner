...
<table style=" border: 1px solid #dee2e6;border-collapse: collapse;" width="100%">
	<tbody>
	 ...
	 <div style="width:50%;display:inline-block;text-align:right">
      <div class="w3-light-grey w3-round-large" style="w3-light-grey w3-round-large" style="text-align:left;display:flex;justify-content:flex-end;">
        <div class="w3-container w3-blue w3-round-large" style="width:100%;text-align:center;float:right;"><b>Contact Us</b><br><span><b>Address :</b> {{@$set->address}}</span><br><span><b>Support Email :</b> <a href="mailto:booking@holidaychacha.com" style="color:#89ad3e;"> {{@$set->b2c_email}}</a></span></div>
		<div style="clear:both;float:none;"></div>
      </div>
    </div>
