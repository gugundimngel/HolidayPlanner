...
<ul>
@if(isset($_GET['ref']))
<li class="export"><a href="{{URL::to('/admin/report/ledger')}}?ref={{@$_GET['ref']}}&type=excel"><i class="fas fa-file-excel"></i> Excel Export</a></li>
<li class="export"><a href="{{URL::to('/admin/report/ledger')}}?ref={{@$_GET['ref']}}&type=pdf"><i class="fas fa-file-excel"></i> PDF Report</a></li>
<li class="print"><a href="javascript:;" dataurl="{{URL::to('/admin/report/ledger')}}?ref={{@$_GET['ref']}}&type=print" class="print_myinvoice"><i class="fas fa-print"></i> Print</a></li>
@else 
	<li class="export"><a href="{{URL::to('/admin/report/ledger')}}?agent={{@$_GET['agent']}}&submission_start={{@$_GET['submission_start']}}&submission_end={{@$_GET['submission_end']}}&type=excel"><i class="fas fa-file-excel"></i> Excel Export</a></li>
<li class="export"><a href="{{URL::to('/admin/report/ledger')}}?agent={{@$_GET['agent']}}&submission_start={{@$_GET['submission_start']}}&submission_end={{@$_GET['submission_end']}}&type=pdf"><i class="fas fa-file-excel"></i> PDF Report</a></li>
<li class="print"><a class="print_myinvoice" href="javascript:;" dataurl="{{URL::to('/admin/report/ledger')}}?agent={{@$_GET['agent']}}&submission_start={{@$_GET['submission_start']}}&submission_end={{@$_GET['submission_end']}}&type=print"><i class="fas fa-print"></i> Print</a></li>
@endif
</ul>
</div>
