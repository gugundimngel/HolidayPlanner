...
<body>
    ...
    <div class="container visa_cards_Section">
        ...
        <div class="row">
            ...
            $resulti = $vis->banner_img;
            @endphp
            <div class="col-md-3">
                <div class="card">
                    <div class="cardImg">
                        <img src="{{ !empty($resulti) ? URL::to('/public/img/agentdoc/'). '/'  . $resulti : URL::to('/public/images/visa/dubaivisa.jpg') }}" alt="{{ ucfirst($vis->visa_title) }}">
                    </div>
                    <div class="card_details">
                      <a href="{{ url('/visa/details/'). '/' .$vis->slug }}" class="">  <h5>{{$vis->visa_title ?? ''}}</h5></a>
                        <div class="flexBox">
                            <div>
                                <!--<p>5 Reviews</p>-->
                            ...
                            <a href="{{ url('/visa/details/'). '/' .$vis->slug }}" class="enquiryBtn">Enquire Now</a>
                        </div>
                    </div>
                </div>
            </div>
