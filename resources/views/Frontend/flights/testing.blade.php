					...
					<div class="row">
						<div class="col-md-9 col-sm-12">
							<div class="inner_booking">
														...
														<ul class="list-search-result booking_list">
															<li class="flight_name">
																...
																<div class="name">@if($allflighdata[$fl]->Airline->AirlineCode == 'I5')
																	...
																	@endif<span class="flight_no">{{$allflighdata[$fl]->Airline->AirlineCode}}-{{$allflighdata[$fl]->Airline->FlightNumber}}</span>
																</div>
															</li>
															...
															<li class="flight_amenties">
																<div class="top"><span class="duration"><i class="fa fa-clock"></i> <?php echo Controller::GetFetilFlightTimeduration($allflighdata[$fl]); ?></span><span class="grey_rtbrder">|</span> <!--<span class="meal"> <i class="fa fa-utensils"></i>
													@if($resultdata[0]->Fare->TotalMealCharges == 0)
														Free Meal
													@else 
													Paid @endif</span><span class="grey_rtbrder">|</span> --><span class="economy">
																		<?php if ($allflighdata[$fl]->CabinClass == 2) {
																			echo 'Economy';
																		} else if ($allflighdata[$fl]->CabinClass == 3) {
																			echo 'PremiumEconomy';
																		} else if ($allflighdata[$fl]->CabinClass == 4) {
																			echo 'Business';
																		} else if ($allflighdata[$fl]->CabinClass == 4) {
																			echo 'PremiumBusiness';
																		} else if ($allflighdata[$fl]->CabinClass == 6) {
																			echo 'First';
																		} else {
																			echo 'All';
																		} ?>
														...
														<ul class="list-search-result booking_list">
															<li class="flight_name">
																...
																<div class="name">@if($arriveflighdata[$fla]->Airline->AirlineCode == 'I5')
																	...
																	@endif<span class="flight_no">{{$arriveflighdata[$fla]->Airline->AirlineCode}}-{{$arriveflighdata[$fla]->Airline->FlightNumber}}</span>
																</div>
															</li>
															<li class="flight_time">
								...
								<div class="booking_title block-content-2 custom_block_content login_booking_sec">
									<h3><img src="{!! asset('public/images/travel-details.png') !!}" alt="" /> Login to Holiday Planner Account</h3>
									@if(@Auth::user())<div class="sub_title">Welcome {{@Auth::user()->first_name}} {{Auth::user()->last_name}}</div> @else <div class="sub_title"><a href="javascript:;" class="open_signin">Sign in</a> to book faster</div>@endif
								</div>
								...
								<div class="block-content-2 custom_block_content contact_detail">
									<div class="box-result custom_box_result">
										<div class="col-sm-2 contact_label cus_label">Contact Information</div>
										<div class="col-sm-12 padd0">
											...
											<div class="form_field country_field">
												<div class="country_code"><input class="" id="telephone" type="tel" name="telephone" readonly></div>
												<div class="mobile_no"><input data-valid="required minlength7 maxlength15" value="{{@Auth::user()->phone}}" id="phone" name="phone" type="tel" placeholder="Mobile Number" class="form-control" /></div>
											</div>
										...
										<div class="traveller_info">
											...
											for ($ic = 0; $ic < count($farebrakdowna); $ic++) {
												...
												if ($farebrakdowna[$ic]->PassengerType == 1) {
													$hfAdultCount = $farebrakdowna[$ic]->PassengerCount;
												} else if ($farebrakdowna[$ic]->PassengerType == 2) {
													$hfChildCount = $farebrakdowna[$ic]->PassengerCount;
												} else {
													$hfInfantCount = $farebrakdowna[$ic]->PassengerCount;
												}
											...
											?>
													<div class="row">
														<div class="col-sm-12">
															<h6>Passenger {{$ics}} - <?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																							echo '(Adults';
																						} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																							echo '(Child';
																						} else {
															...
															<div class="col-sm-12 padd0">
																<div class="form_field form_select_field">
																	<select id="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																					echo 'ddlAdultTitle' . $jss;
																				} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																					echo 'ddlChildTitle' . $jss;
																				} else {
																					echo 'ddlInfantTitle' . $jss;
																				} ?>" data-valid="required" class="form-control" name="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																																																																																			echo 'adulttitle[]';
																																																																																		} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																																																																																			echo 'childtitle[]';
																																																																																		} else {
																	...
																	<input id="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																					echo 'txtAdultFName' . $jss;
																				} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																					echo 'txtChildFName' . $jss;
																				} else {
																					echo 'txtInfantFName' . $jss;
																				} ?>" data-valid="required minlength1 maxlength32" type="text" name="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																																																																																						echo 'adultfirstname[]';
																																																																																					} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																																																																																						echo 'childfirstname[]';
																																																																																					} else {
																																																																																						echo 'infantfirstname[]';
																																																																																					} ?>" placeholder="First Name" class="form-control <?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																																																																																																																																																	echo 'firstname';
																																																																																																																																																} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																																																																																																																																																	echo 'firstname';
																																																																																																																																																} else {
																...
																<div class="form_field">
																	<input id="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																					echo 'txtAdultLName' . $jss;
																				} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																					echo 'txtChildLName' . $jss;
																				} else {
																					echo 'txtInfantLName' . $jss;
																				} ?>" data-valid="required minlength2 maxlength32" data-valid="required" type="text" name="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																																																																																												echo 'adultlastname[]';
																																																																																											} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																																																																																												echo 'childlastname[]';
																																																																																											} else {
																																																																																												echo 'infantlastname[]';
																																																																																											} ?>" placeholder="Last Name" class="form-control <?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																																																																																																																																																						echo 'lastname';
																																																																																																																																																					} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																																																																																																																																																						echo 'lastname';
																																																																																																																																																					} else {
																	...
																	<input type="hidden" name="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																									echo 'adultseataddons[]';
																								} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																									echo 'childseataddons[]';
																								} else {
																									echo 'infantseataddons[]';
																								} ?>" class="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																																																																											echo 'atxtAdultLName' . $jss;
																																																																										} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																																																																											echo 'atxtChildLName' . $jss;
																																																																										} else {
																																																																											echo 'atxtInfantLName' . $jss;
																																																																										} ?>">
																	<input type="hidden" name="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																									echo 'adultmealaddons[]';
																								} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																									echo 'childmealaddons[]';
																								} else {
																									echo 'infantmealaddons[]';
																								} ?>" class="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																																																																											echo 'btxtAdultLName' . $jss;
																																																																										} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																																																																											echo 'btxtChildLName' . $jss;
																																																																										} else {
																																																																											echo 'btxtInfantLName' . $jss;
																																																																										} ?>">
																	<input type="hidden" name="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																									echo 'adultbagaddons[]';
																								} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																									...
																									echo 'infantbagaddons[]';
																								} ?>" class="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																																																																											echo 'ctxtAdultLName' . $jss;
																																																																										} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																																																																											echo 'ctxtChildLName' . $jss;
																																																																										} else {
																																																																											echo 'ctxtInfantLName' . $jss;
																																																																										} ?>">
																</div>
																<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																...
																?>
																		<div class="form_field">
																			<input id="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																							echo 'txtDOBAdult' . $jss;
																						} ?>" data-valid="required <?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																																																	echo 'adultdob';
																																																} ?>" type="text" name="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																																																																								echo 'adultdob[]';
																																																																							} ?>" placeholder="Date of Birth" class="form-control <?php if ($farebrakdowna[$ic]->PassengerType == 1) { ?>datepicker-adulttime-start<?php } ?>" />
																		</div>
																	<?php
																	}
																} else {
																	...
																	<div class="form_field">
																		<input id="<?php if ($farebrakdowna[$ic]->PassengerType == 2) {
																						echo 'txtDOBChild' . $jss;
																					} else {
																						echo 'txtDOBInfant' . $jss;
																					} ?>" data-valid="required <?php if ($farebrakdowna[$ic]->PassengerType == 2) {
																																																								echo 'childdob';
																																																							} else if ($farebrakdowna[$ic]->PassengerType == 3) {
																																																								echo 'infantdob';
																																																							} ?>" type="text" name="<?php if ($farebrakdowna[$ic]->PassengerType == 2) {
																																																																																																echo 'childdob[]';
																																																																																															} else {
																																																																																																echo 'infantdob[]';
																																																																																															} ?>" placeholder="Date of Birth" class="form-control <?php if ($farebrakdowna[$ic]->PassengerType == 2) { ?>datepicker-child-time-start<?php } else if ($farebrakdowna[$ic]->PassengerType == 3) { ?>datepicker-infant-time-start<?php } ?>" />
																	</div>
																<?php } ?>
															</div>
															...
															<?php
																	...
																	<div class="row">
																		...
																		<div class="col-md-6 col-sm-6 col-xs-12">
																			...
																			<div class="ssrloadershow" style="display:none;">
																				<a href="javascript:;" style="padding:5px 10px;" class="btn btn-primary btn-sm showmeals" name="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																																													echo 'mealBoxAdult' . $jss;
																																												} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																																													echo 'mealBoxChild' . $jss;
																																												} else {
																																													echo '';
																																												} ?>"><i class="fa fa-hamburger"></i>&nbsp;Add Meal</a>
																				<a href="javascript:;" style="padding:5px 10px;" class="btn btn-primary btn-sm showbags" name="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																																													echo 'baggageBoxAdult' . $jss;
																																												} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																																													echo 'baggageBoxChild' . $jss;
																																												} else {
																																													echo '';
																																												} ?>"><i class="fa fa-luggage-cart"></i>&nbsp; Add Baggage</a>
																			</div>
																		</div>
																	</div>
																</div>
																<div class="service_req_sec service_req_sec_nseat meal_info" id="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																																		echo 'mealBoxAdult' . $jss;
																																	} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																																		echo 'mealBoxChild' . $jss;
																																	} else {
																	...
																	<ul class="nav nav-tabs custom_tabs">
																		...
																		if (isset($resultdata[0]->Segments[0])) {
																			...
																			for ($fl = 0; $fl < count($allflighdata); $fl++) {
																		?>
																				<li class="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																								echo 'mypasadult-' . $jss;
																							} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																								echo 'mypaschild-' . $jss;
																							} else {
																								echo '';
																																																																			...
																																																																			echo 'active';
																																																																		} ?> countdepvalue"><a href="#<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																																																																																			echo 'pasadult-' . $jss . '-' . $allflighdata[$fl]->Origin->Airport->CityCode . '-' . $allflighdata[$fl]->Destination->Airport->CityCode;
																																																																																		} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																																																																																			echo 'paschild-' . $jss . '-' . $allflighdata[$fl]->Origin->Airport->CityCode . '-' . $allflighdata[$fl]->Destination->Airport->CityCode;
																																																																																		} else {
																																																																																			echo '';
																																																																																		} ?>" aria-controls="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																																																																																																																																																																																						echo 'pasadult-' . $jss . '-' . $allflighdata[$fl]->Origin->Airport->CityCode . '-' . $allflighdata[$fl]->Destination->Airport->CityCode;
																																																																																																																																																																																					} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																																																																																																																																																																																						echo 'paschild-' . $jss . '-' . $allflighdata[$fl]->Origin->Airport->CityCode . '-' . $allflighdata[$fl]->Destination->Airport->CityCode;
																																																																																																																																																																																					} else {
																																																																																																																																																																																						echo '';
																																																																																																																																																																																					} ?>" role="tab" data-toggle="tab">{{$allflighdata[$fl]->Origin->Airport->CityCode}} - {{$allflighdata[$fl]->Destination->Airport->CityCode}}</a></li>
																				<input type="hidden" name="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																												echo 'mealadult[]';
																											} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																												echo 'mealchild[]';
																												...
																												echo '';
																											} ?>" value="{{$allflighdata[$fl]->Origin->Airport->CityCode}}-{{$allflighdata[$fl]->Destination->Airport->CityCode}}">
																			<?php } ?>
																			<?php }
																	...
																	<div class="tab-content">
																		<?php if (isset($resultdata[0]->Segments[0])) {
																			...
																			for ($fl = 0; $fl < count($allflighdata); $fl++) {
																		?>
																				<div role="tabpanel" class="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																												echo 'mydpasadult-' . $jss;
																											} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																												echo 'mydpaschild-' . $jss;
																											} else {
																												echo '';
																											} ?> tab-pane <?php if ($fl == 0) {
																																																																										echo 'active';
																																																																									} ?>" id="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																																																																																					echo 'pasadult-' . $jss . '-' . $allflighdata[$fl]->Origin->Airport->CityCode . '-' . $allflighdata[$fl]->Destination->Airport->CityCode;
																																																																																				} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																																																																																					echo 'paschild-' . $jss . '-' . $allflighdata[$fl]->Origin->Airport->CityCode . '-' . $allflighdata[$fl]->Destination->Airport->CityCode;
																																																																																				} else {
																					...
																					<div class="meals_list service_req_list dep_meal_sele">
																						<ul id="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																									echo 'adultmeal_' . $jss . '_' . $allflighdata[$fl]->Origin->Airport->CityCode . '-' . $allflighdata[$fl]->Destination->Airport->CityCode;
																								} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																									echo 'childmeal_' . $jss . '_' . $allflighdata[$fl]->Origin->Airport->CityCode . '-' . $allflighdata[$fl]->Destination->Airport->CityCode;
																								} else {
																									echo 'infantmeal_' . $jss;
																								} ?>" class="b_{{$allflighdata[$fl]->Origin->Airport->CityCode.'-'.$allflighdata[$fl]->Destination->Airport->CityCode}}" vclass="{{$allflighdata[$fl]->Origin->Airport->CityCode.'-'.$allflighdata[$fl]->Destination->Airport->CityCode}}">

																						</ul>
																						<div class="clearfix"></div>
																					</div>
																					<span class="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																										echo 'adultmeal_' . $jss;
																									} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																										echo 'childmeal_' . $jss;
																									} else {
																		...
																		?>
																				<div role="tabpanel" class="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																												...
																												echo '';
																											} ?> tab-pane " id="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																																																																												echo 'pasadult-' . $jss . '-' . $allflighdata[$fl]->Origin->Airport->CityCode . '-' . $allflighdata[$fl]->Destination->Airport->CityCode;
																																																																											} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																																																																												echo 'paschild-' . $jss . '-' . $allflighdata[$fl]->Origin->Airport->CityCode . '-' . $allflighdata[$fl]->Destination->Airport->CityCode;
																																																																											} else {
																					...
																					<div class="retmeals_list service_req_list dep_meal_sele">
																						<ul id="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																									echo 'returnadultmeal_' . $jss . '_' . $allflighdata[$fl]->Origin->Airport->CityCode . '-' . $allflighdata[$fl]->Destination->Airport->CityCode;
																								} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																									echo 'returnchildmeal_' . $jss . '_' . $allflighdata[$fl]->Origin->Airport->CityCode . '-' . $allflighdata[$fl]->Destination->Airport->CityCode;
																								} else {
																									echo 'returninfantmeal_' . $jss;
																								} ?>" class="b_{{$allflighdata[$fl]->Origin->Airport->CityCode.'-'.$allflighdata[$fl]->Destination->Airport->CityCode}}" vclass="{{$allflighdata[$fl]->Origin->Airport->CityCode.'-'.$allflighdata[$fl]->Destination->Airport->CityCode}}">
																					...
																					<span class="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																										echo 'returnadultmeal_' . $jss;
																									} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																										echo 'returnchildmeal_' . $jss;
																									} else {
																										echo 'returninfantmeal_' . $jss;
																									} ?> mealdetail" style="display:none;">
																						<kbd>Meal Qunatity : <code style="float:none;" class="mealwth">0</code> Platter</kbd>
																...
																<div class="service_req_sec service_req_sec_nseat baggage_info" id="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																																		echo 'baggageBoxAdult' . $jss;
																																	} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																																		echo 'baggageBoxChild' . $jss;
																																	} else {
																	...
																	<ul class="nav nav-tabs custom_tabs">
																		...
																		?>
																			<li class="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																							echo 'mybagpasadult-' . $jss;
																						} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																							echo 'mybagpaschild-' . $jss;
																						} else {
																							echo '';
																						} ?> <?php if ($fl == 0) {
																																																																				echo 'active';
																																																																			} ?> countdepvalue"><a href="#<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																																																																																				echo 'bagpasadult-' . $jss . '-' . $allflighdata[$fl]->Origin->Airport->CityCode . '-' . $allflighdata[$fl]->Destination->Airport->CityCode;
																																																																																			} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																																																																																				echo 'bagpaschild-' . $jss . '-' . $allflighdata[$fl]->Origin->Airport->CityCode . '-' . $allflighdata[$fl]->Destination->Airport->CityCode;
																																																																																			} else {
																																																																																				echo '';
																																																																																			} ?>" aria-controls="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																																																																																																																																																																																								echo 'bagpasadult-' . $jss . '-' . $allflighdata[$fl]->Origin->Airport->CityCode . '-' . $allflighdata[$fl]->Destination->Airport->CityCode;
																	...
																	<div class="tab-content">
																		...
																		?>
																			<div role="tabpanel" class="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																											echo 'mydbagpasadult-' . $jss;
																										} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																											echo 'mydbagpaschild-' . $jss;
																										} else {
																											echo '';
																										} ?> tab-pane active" id="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																																																																														echo 'bagpasadult-' . $jss . '-' . $allflighdata[$fl]->Origin->Airport->CityCode . '-' . $allflighdata[$fl]->Destination->Airport->CityCode;
																																																																													} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																																																																														echo 'bagpaschild-' . $jss . '-' . $allflighdata[$fl]->Origin->Airport->CityCode . '-' . $allflighdata[$fl]->Destination->Airport->CityCode;
																																																																													} else {
																				...
																				<div class="baggage_list service_req_list dep_baggage_sele">
																					<ul id="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																								echo 'adultbaggage_' . $jss . '_' . $allflighdata[$fl]->Origin->Airport->CityCode . '-' . $allflighdata[$fl]->Destination->Airport->CityCode;
																							} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																								echo 'childbaggage_' . $jss . '_' . $allflighdata[$fl]->Origin->Airport->CityCode . '-' . $allflighdata[$fl]->Destination->Airport->CityCode;
																							} else {
																								echo '' . $jss;
																							} ?>">
																					...
																					<div class="clearfix"></div>
																					<span class="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																										echo 'adultbaggage_' . $jss;
																									} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																										echo 'childbaggage_' . $jss;
																									} else {
																										echo '' . $jss;
																									} ?> mealdetail" style="display:none;">
																		...
																		?>
																			<div role="tabpanel" class="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																				...
																				<div class="baggage_list service_req_list dep_baggage_sele">
																					<ul id="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																								echo 'returnadultbaggage_' . $jss . '_' . $allflighdata[$fl]->Origin->Airport->CityCode . '-' . $allflighdata[$fl]->Destination->Airport->CityCode;
																							} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																								echo 'returnchildbaggage_' . $jss . '_' . $allflighdata[$fl]->Origin->Airport->CityCode . '-' . $allflighdata[$fl]->Destination->Airport->CityCode;
																							} else {
																								echo '' . $jss;
																							} ?>">
																					...
																					<div class="clearfix"></div>
																					<span class="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																										echo 'returnadultbaggage_' . $jss;
																									} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																										echo 'returnchildbaggage_' . $jss;
																									} else {
																										echo '' . $jss;
																									} ?> mealdetail" style="display:none;">
													...
													<div class="row">
														<div class="col-sm-12">
															...
															<div class="col-sm-10">
																...
																<div class="form_field">
																	<input maxlength="16" id="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																									echo 'txtAdultPassport' . $jss;
																								} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																									echo 'txtChildPassport' . $jss;
																								} else {
																									echo 'txtChildPassportExp' . $jss;
																								} ?>" data-valid="required pasmaxlength15 PassportNoValidator" type="text" name="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																																																																																																echo 'adultpassportno[]';
																																																																																															} else if ($farebrakdowna[$jss]->PassengerType == 2) {
																																																																																																echo 'childpassportno[]';
																																																																																															} else {
																																																																																																echo 'infantpassportno[]';
																																																																																															} ?>" placeholder="Passport Number" class="form-control" />
																</div>
																<div class="form_field">
																	<input data-valid="required" id="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																											echo 'txtAdultPassportExp' . $jss;
																										} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																											echo 'txtChildPassportExp' . $jss;
																										} else {
																											echo 'txtInfantPassportExp' . $jss;
																										} ?>" type="text" name="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																																																																																					echo 'adultpassportdate[]';
																																																																																				} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																																																																																					echo 'childpassportdate[]';
																																																																																				} else {
																																																																																					echo 'infantpassportdate[]';
																																																																																				} ?>" placeholder="Passport Expire date" class="form-control datepicker-3-time-start" />
																</div>
								...
								<!--<div class="extra_addons">-->
								<!--	<div class="booking_title">-->
								<!--		<h3>Add-ons (Optional)</h3>-->
								<!--	</div>-->
								<!--	<div class="block-content-2 custom_block_content">-->
								<!--		<div class="addonBtns">-->
								<!--			<button class="btn btnAddon"><i class="fa fa-hamburger"></i> Add Meal</button>-->
								<!--			<button class="btn btnAddon"><i class="fa fa-luggage-cart"></i> Add Baggage</button>-->
								<!--		</div>-->
								<!--	</div>-->
								<!--</div>-->
											...
											<div class="service_req_sec">
												<ul class="nav nav-tabs custom_tabs">
													...
													if (isset($resultdata[0]->Segments[0])) {
														...
														for ($fl = 0; $fl < count($allflighdata); $fl++) { ?>
															<li class="<?php if ($fl == 0) {
																			echo 'active';
																		} ?>"><a id="SegSeatSelect_0_Seg_{{$fl}}" href="#departure_seat{{$fl}}" aria-controls="departure_seat{{$fl}}" role="tab" data-toggle="tab">{{$allflighdata[$fl]->Origin->Airport->CityCode}} - {{$allflighdata[$fl]->Destination->Airport->CityCode}}</a>

															</li>
														<?php } ?>
													<?php } ?>
													<?php if (!empty($resultdataib)) {
														if (isset($resultdataib[0]->Segments[0])) {
															$res = $resultdataib[0];
															$allflighdata = $res->Segments[0];
													?>
												...
												<div class="tab-content">
													<?php if (isset($resultdata[0]->Segments[0])) {
														...
														for ($fl = 0; $fl < count($allflighdata); $fl++) {
													?>
															<div role="tabpanel" class="tab-pane <?php if ($fl == 0) {
																										echo 'active';
																									} ?>" id="departure_seat{{$fl}}">
																				...
																				<div class="ticket_info">
																					...
																					?>
																								<div class="ticket_col">
																									<div class="tic_label"><?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																																echo 'Adult';
																															} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																																echo 'Child';
																															} ?> {{$ics}} <span fid="{{$allflighdata[$fl]->Origin->Airport->CityCode}} - {{$allflighdata[$fl]->Destination->Airport->CityCode}}" tif="<?php if ($farebrakdowna[$ic]->PassengerType == 1) { ?>adultPaxSeat_{{$jss}}_0_Seg_{{$fl}}_paxCount<?php } else if ($farebrakdowna[$ic]->PassengerType == 2) { ?>childPaxSeat_{{$jss}}_0_Seg_{{$fl}}_paxCount<?php } ?>" class="seatnumber" id="PaxSeat_0_Seg_{{$fl}}_paxCount_{{$j}}" style="visibility:hidden;"></span></div>
																									<div class="tic_price">Rs <code id="PaxSeatCH_0_Seg_{{$fl}}_paxCount_{{$j}}">0.00</code></div>
																									<input class="PaxSeat_0_Seg_{{$fl}}_paxCount_{{$j}}" type="hidden" name="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																																													echo 'adult_' . $jss . '_PaxSeat_0_Seg_' . $fl . '_paxCount_' . $j;
																																												} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																																													echo 'child_' . $jss . '_PaxSeat_0_Seg_' . $fl . '_paxCount_' . $j;
																																												} ?>">
																								</div>
																					<?php $jss++;
																							}
																						...
																						?>
																									<div class="ticket_col">
																										<div class="tic_label"><?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																																	...
																																	echo 'Child';
																																} ?> {{$ics}} <span class="seatnumber" id="PaxSeat_1_Seg_{{$fl}}_paxCount_{{$j}}" fid="{{$allflighdata[$fl]->Origin->Airport->CityCode}} - {{$allflighdata[$fl]->Destination->Airport->CityCode}}" tif="<?php if ($farebrakdowna[$ic]->PassengerType == 1) { ?>adultPaxSeat_{{$jss}}_1_Seg_{{$fl}}_paxCount<?php } else if ($farebrakdowna[$ic]->PassengerType == 2) { ?>childPaxSeat_{{$jss}}_1_Seg_{{$fl}}_paxCount<?php } ?>" style="visibility:hidden;"></span></div>
																										<div class="tic_price">Rs <code id="PaxSeatCH_1_Seg_{{$fl}}_paxCount_{{$j}}">0.00</code></div>
																										<input class="PaxSeat_1_Seg_{{$fl}}_paxCount_{{$j}}" type="hidden" name="<?php if ($farebrakdowna[$ic]->PassengerType == 1) {
																																														echo 'returnadult_' . $jss . '_PaxSeat_1_Seg_' . $fl . '_paxCount_' . $j;
																																													} else if ($farebrakdowna[$ic]->PassengerType == 2) {
																																														echo 'returnchild_' . $jss . '_PaxSeat_1_Seg_' . $fl . '_paxCount_' . $j;
																																													} ?>">
																									</div>
																									<?php
									...
									<div class="box-result custom_box_result">
										...
										<div class="gst_form">
											...
											<div class="col-sm-6 col-xs-6 col_xs_480">
												<div class="form-group">
													<div class="row">
														<label class="col-sm-4 col-xs-12 pad_rt0">GST Holder Name</label>
														<div class="col-sm-8 col-xs-12">
								...
								<div class="inner_fare">
									...
									<div class="fare_rules sidebar_bgclr inner_sidebar" id="DivFareQuote">
										<ul>
											...
											?>
												<?php $vasefarec = 0;
												for ($fbs = 0; $fbs < count($farebrakdown); $fbs++) {
													$vasefarec += $farebrakdown[$fbs]->BaseFare + $farebrakdownR[$fbs]->BaseFare;
												}  ?>
												<li class="basefare">Base Fare <small>(<?php echo $mtcount; ?> Traveller)</small> <i class="fa fa-angle-down"></i>
													...
													<ul class="inner_ul">
														<?php for ($fb = 0; $fb < count($farebrakdown); $fb++) { ?>
															<li><?php if ($farebrakdown[$fb]->PassengerType == 1) {
																	echo 'Adults';
																} else if ($farebrakdown[$fb]->PassengerType == 2) {
																	echo 'Child';
																} else {
																	echo 'Infant';
																} ?> x <?php echo $farebrakdown[$fb]->PassengerCount ?> <span class="price"><i class="fa fa-rupee-sign"></i> <?php echo number_format($farebrakdown[$fb]->BaseFare + $farebrakdownR[$fb]->BaseFare); ?></span></li>
														<?php } ?>
													</ul>
												</li>
												<li class="fee_subcharge">Taxes & Subcharges <!--<i class="fa fa-angle-down"></i>-->
													<?php if (@$_GET['IsInt'] == 'False') {
											...
											?>
												...
												<?php $vasefarec = 0;
												for ($fbs = 0; $fbs < count($farebrakdown); $fbs++) {
													$vasefarec += $farebrakdown[$fbs]->BaseFare;
												}  ?>
												<li class="basefare">Base Fare <small>(<?php echo $mtcount; ?> Traveller)</small> <i class="fa fa-angle-down"></i>
													<span class="price"><i class="fa fa-rupee-sign"></i> {{number_format($vasefarec)}}</span>
													<ul class="inner_ul">
														<?php for ($fb = 0; $fb < count($farebrakdown); $fb++) { ?>
															<li><?php if ($farebrakdown[$fb]->PassengerType == 1) {
																	...
																	echo 'Infant';
																} ?> x <?php echo $farebrakdown[$fb]->PassengerCount ?> <span class="price"><i class="fa fa-rupee-sign"></i> <?php echo number_format($farebrakdown[$fb]->BaseFare); ?></span></li>
														<?php } ?>
													</ul>
												</li>
