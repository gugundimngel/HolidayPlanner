	...
	$.ajax({
	   ...
	   success:function(data)
	   {
		...
		$('.onewayformsearch').on('click', function(){
			...
			if(flag){
				window.location.href= "{{URL::to('/agent/FlightList/index')}}?srch="+val1+"|"+val2+"|"+onewaystartdate+"&px="+onewayadult+"-"+onewaychild+"-"+onewayinfants+"&cbn="+seatclass+"&nt="+is_non_stop+"&jt="+journey_type;
			}
		});
		...
		$('.roundformsearch').on('click', function(){
			...
			if(flag){
				if(journey_type == 2){
					...
					$('.searchpop1').show();
					window.location.href= "{{URL::to('/agent/FlightList/index')}}?srch="+val1+"|"+val2+"|"+onewaystartdate+"|"+onewayenddate+"&px="+onewayadult+"-"+onewaychild+"-"+onewayinfants+"&cbn="+seatclass+"&nt="+is_non_stop+"&jt="+journey_type;
				}else{
					$("#dvWait").html(WaitSearch());
					$('.searchpop1').show();
					window.location.href= "{{URL::to('/agent/FlightList/index')}}?srch="+val1+"|"+val2+"|"+onewaystartdate+"&px="+onewayadult+"-"+onewaychild+"-"+onewayinfants+"&cbn="+seatclass+"&nt="+is_non_stop+"&jt="+journey_type;
